...
OOB_CALLBACK_URN = 'http://localhost:8000/contact/auth_success/'
...
def flow_from_clientsecrets(filename, scope, redirect_uri=None,
  ...
  try:
    ...
    if client_type in (clientsecrets.TYPE_WEB, clientsecrets.TYPE_INSTALLED):
      ...
      #OOB_CALLBACK_URN = client_info['redirect_uris']
      print (client_info.get('redirect_uri'))
